...
$(document).ready(function () {
    ...
    $("#open-card-overlay").click(function() {
        ...
        if (openCardWindowShow) {
            ...
            var full_name = localStorage.getItem('fullname') ? localStorage.getItem('fullname') : "Pelle Berger";
            $("#card1-fullname,#card2-fullname").text(full_name);
            var personal_number = localStorage.getItem('PN') ? localStorage.getItem('PN'): "000419-4874";
